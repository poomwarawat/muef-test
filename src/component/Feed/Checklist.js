...
const Checklist = (props) => {    
    ...
    const handleClick = () => {         
        const {firstname, lastname, nickname, gender, birthday, salary, stdCode, stdRoom, schoolname, region, district, province} = student
        ...
        <div className="checklist-user">
            <Container>
                ...
                <Form>
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input onChange={handleChange} type="text" id="firstname" name="firstname" placeholder="กรุณาใส่ชื่อ"/>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label htmlFor="lastname">นามสกุล</Label>
                                <Input onChange={handleChange} type="text" id="lastname" name="lastname" placeholder="กรุณาใส่นามสกุล"/>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label htmlFor="nickname">ชื่อเล่น</Label>
                                <Input onChange={handleChange} type="text" id="nickname" name="nickname" placeholder="กรุณาใส่ชื่อเล่น"/>
                            </FormGroup>
                        </Col>
                    </Row>
                    <Row>
                        <Col md={4}>
                            ...
                            <FormGroup check>
                            <Label check>
                                <Input checked={student.gender === 'male'} onChange={handleChange} type="radio" id="gender" value="male"/>{' '}
                                ชาย
                            </Label>
                            </FormGroup>
                            <FormGroup check>
                            <Label check>
                                <Input checked={student.gender === 'female'} onChange={handleChange} type="radio" id="gender" value="female" />{' '}
                                หญิง
                            </Label>
                            </FormGroup>                                                                   
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label htmlFor="birthday">วันเกิด (อายุต้องอยู่ระหว่าง 2-6 ปี)</Label><br/>
                    ...
                    <Row>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input onChange={handleChange} type="select" name="salary" id="salary">
                    ...
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input onChange={handleChange} type="text" id="stdCode" name="stdCode" placeholder="กรุณาใส่เลขที่"/>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label htmlFor="room">ห้อง</Label>
                                <Input onChange={handleChange} type="text" id="stdRoom" name="stdRoom" placeholder="กรุณาใส่ห้อง"/>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label htmlFor="schoolname">โรงเรียน/ ศูนย์พัฒนาเด็ก</Label>
                                <Input onChange={handleChange} type="text" id="schoolname" name="schoolname" placeholder="กรุณาใส่ชื่อโรงเรียน/ ศูนย์พัฒนาเด็ก"/>
                            </FormGroup>
                        </Col>
                    </Row>
                    <Row form>
                        <Col md={4}>
                            <FormGroup>
                                ...
                                <Input onChange={handleChange} type="text" id="region" name="region" placeholder="กรุณาใส่ตำบล"/>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                                <Label htmlFor="room">อำเภอ</Label>
                                <Input onChange={handleChange} type="text" id="district" name="district" placeholder="กรุณาใส่อำเภอ"/>
                            </FormGroup>
                        </Col>
                        <Col md={4}>
                            <FormGroup>
                    ...
                    <Row>
                        ...
                        <Col md={8}>
                            ...
                            {error && <Alert color="danger" id="Error"> {error} </Alert>}
                        </Col>          
                    </Row>
                </Form>
                ...
                <div>
                    ...
                    <div>
                        <Button onClick={handleClick} color="dark">เริ่มประเมิน</Button>
                    </div>
                </div>
            </Container>
        </div>
