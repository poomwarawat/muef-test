...
const TestingMenu = (props) => {  
    ...
    if(redirect){
        ...
        return(
            <Redirect to={`/MUEF-TEST-101/${splitCode[4]}/result`}/>
        )
    }
    const handleSave = () => {        
        setRedirect(true)
        ...
        <div>
            ...
            <div>                
                ...
                <div className="mt-4">
                    ...
                    <p>หากทำแบบประเมินครบแล้วไม่สามารถกดปุ่ม "บันทึกผลและดูคะแนน" กรุณากดรีเฟรซ (Refresh)</p>
                </div>
                <div className="back-menu">
                    ...
                    <div>                        
                        <Button onClick={handleSave} disabled={result} color="light">บันทึกผลและดูคะแนน</Button>                        
                    </div>
                </div>
            </div>
        </div>
